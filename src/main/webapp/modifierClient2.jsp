                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="tel" required class="form-control" pattern="^(\d{3}-\d{3}-\d{4}|\d{10})$" id="telephone" name="telephone"
                               placeholder="5144567890" value="${client.telephone}">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-9">
                        ...
                        <input type="text" class="form-control" id="address" name="rue"
                               placeholder="Rue Saint-Urbain " pattern="^[A-Za-z\u00C0-\u017F\s-]+$" value="${client.adresse.rue}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" pattern="^[A-Za-z\u00C0-\u017F\s-]+$" class="form-control" id="ville" name="ville"
                               placeholder="Montréal" value="${client.adresse.ville}" required>
                        <div class="invalid-feedback">
